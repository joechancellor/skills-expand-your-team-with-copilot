...
def get_activities(
    ...
    - difficulty: Filter activities by difficulty level (e.g., 'Beginner', 'Intermediate', 'Advanced', 'AllLevels')
                  'AllLevels' returns only activities with no difficulty specified (suitable for all skill levels)
    """
    ...
    if difficulty:
        if difficulty == "AllLevels":
            # "AllLevels" means activities with no difficulty specified (suitable for all skill levels)
